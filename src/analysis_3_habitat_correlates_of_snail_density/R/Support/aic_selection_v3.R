...
aic_sel <- function( data_list = data_list, params = params, version = version, map = map, random = random , BIC_sel = T, bulinus, wd = getwd(), file_name = "NULL"){
  ...
  opt = tryCatch(optim(obj$par, obj$fn, obj$gr, control = list(maxit = 100000), method = "BFGS"), error = function(e) NULL)
